...
public class Fenetre2 extends JFrame {
	...
	private void go() {
		...
		System.out.println("go() : " + $currentThread.getId() + " - " + t.getState());
	...
	public class BoutonGoListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent arg0) {
			...
			System.out.println("BoutonGO : " + t.getId() + " - " + t.getState());
		}
	}
	...
	class PlayAnimation implements Runnable {
		@Override
		public void run() {
			System.out.println("before go() : " + t.getId() + " - " + t.getState());
			go();
			System.out.println("after go() : " + t.getId() + " - " + t.getState());
		}
	}
